...
export default function Card({ title, image, alt, classname }: CardProps) {
    return (
        <div className={`text-white flex flex-col items-center justify-center bg-gray-300/5 border-1 border-blue-300/30 rounded-xl pt-4 px-4 lg:w-auto w-full ${classname}`}>
